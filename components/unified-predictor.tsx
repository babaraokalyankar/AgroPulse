...
import { ArrowLeft, Loader2, CheckCircle, AlertTriangle, Thermometer, Droplets, Beaker } from "lucide-react"
...
export default function UnifiedPredictor({ onBack, onPrediction }: UnifiedPredictorProps) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('/placeholder.svg?height=1080&width=1920&text=Turmeric+Cultivation')`,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-white/80">Complete crop and soil health assessment</p>
            </div>
          </div>
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-2xl">
            <CardHeader className="bg-gradient-to-r from-green-600 to-yellow-600 text-white rounded-t-lg">
            ...
            <CardContent className="p-8">
              ...
              {currentStep === 1 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="soil_pH" className="text-lg font-medium">
                      Soil pH
                    </Label>
                    <Input
                      id="soil_pH"
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Optimal range: 6.0 - 7.5</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Optimal range: 20 - 35°C</p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="rainfall" className="text-lg font-medium">
                      Rainfall (mm)
                    </Label>
                    <Input
                      id="rainfall"
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Monthly rainfall amount</p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="humidity" className="text-lg font-medium">
                      Humidity (%)
                    </Label>
                    <Input
                      id="humidity"
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Relative humidity percentage</p>
                  </div>
                </div>
              )}
              ...
              {currentStep === 2 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="soil_moisture" className="text-lg font-medium">
                      Soil Moisture (%)
                    </Label>
                    <Input
                      id="soil_moisture"
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Current soil moisture content</p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="irrigation_type" className="text-lg font-medium">
                      Irrigation Type
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="fertilizer_type" className="text-lg font-medium">
                      Fertilizer Type
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="pesticide_usage" className="text-lg font-medium">
                      Pesticide Usage (ml)
                    </Label>
                    <Input
                      id="pesticide_usage"
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Monthly pesticide application</p>
                  </div>
                </div>
              )}
              ...
              {currentStep === 3 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="uv_index" className="text-lg font-medium">
                      UV Index (UVI)
                    </Label>
                    <Input
                      id="uv_index"
                      ...
                      required
                    />
                    <p className="text-sm text-gray-500">Daily UV radiation index</p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="season" className="text-lg font-medium">
                      Current Season
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="soil_texture" className="text-lg font-medium">
                      Soil Texture
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="tillage_practice" className="text-lg font-medium">
                      Tillage Practice
                    </Label>
              ...
              <div className="flex justify-between mt-8">
                ...
                {currentStep < 3 ? (
                  ...
                  <Button
                    ...
                    className="px-8 py-3 text-lg bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700"
                  >
                    {loading ? (
                      <>
